...
<?
$sql = "SELECT * FROM medicamentos ORDER by nome_comercial";
$resultado = mysql_query($sql) or die ("Erro na consulta");
?>                      
                    
                    
                    <table class="tablelinha_hover" width="98%" border="0" cellpadding="5" cellspacing="0">
  ...
  <div style="width: 98%; border: 1px dashed gray;"> 
...
<p class="medicamentos" style="padding:3px;">
<a href="detalhes_medicamentos.php?id=<? echo $id ?>"><? echo $nome_comercial ?></a>
</p> 
...
<div id="pgmedicamentos" class="pgvirtual">
...
var medicamentos=new virtualpaginate("medicamentos", 20, "p") 
medicamentos.buildpagination("pgmedicamentos")
</script>       
